...
from src.experiments.paql_eval.direct import DirectExperiment
...
def main():
    parser = ArgumentParser(description="Package Query Test Runner.")
    ...
    if not args.run_now:
        ...
        expdb.sql_update(
            "INSERT INTO exp(exp_dir, query_file, args, expdb, poolsize, logging_level, set_verbose) "
        ...
        experiment.start()
        try:
            experiment(other_args)  # calls direct.py
