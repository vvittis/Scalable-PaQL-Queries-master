...
class DBCursor:
    ...
    def sql_query(self, sql, *data, **kwdata):
        ...
        # print("sql_query start: " + str(time_start))
        ...
        # 	raise KeyboardInterrupt
            ...
            # print( ("%"*50) + "%%%%%%%" + ("%"*50)
            time_end = time.time()
            # print("sql_query end: " + str(time_end))
            # if self.logfile:
    ...
    def sql_update(self, sql, *data, **kwdata):
        ...
        time_start = time.time()
        # print("sql_update start:"+str(time_start))
        ...
        try:
            ...
            self._psql_unnamed_cur.close()
            time_end = time.time()
            # print("sql_update end: "+str(time_end))
